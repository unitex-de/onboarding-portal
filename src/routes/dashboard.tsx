...
// ---------------------------------------------------------------------------
// Tour-Steps – target muss mit data-tour="..." im JSX übereinstimmen
// ---------------------------------------------------------------------------
const TOUR_STEPS: TourStep[] = [
  {
    target: "progress-ring",
    title: "Ihr Gesamtfortschritt",
    body: "Der Ring zeigt auf einen Blick, wie weit Sie im Onboarding sind. 100% bedeutet: alles ausgefüllt, Dokumente hochgeladen, Verträge unterschrieben.",
    placement: "right",
  },
  {
    target: "zr-start-card",
    title: "Voraussichtlicher ZR-Start",
    body: "Dieses Datum berechnet sich automatisch: 10 Werktage nach vollständiger Einreichung, jeweils zum 1. des Folgemonats.",
    placement: "left",
  },
  {
    target: "step-stammdaten",
    title: "Schritt 1 · Stammdaten",
    body: "Hier tragen Sie alle Firmendaten ein: Grunddaten, Kontakt, Bankverbindung, GLN & Filialen sowie wirtschaftlich Berechtigte (GWG). Klicken Sie rein und füllen Sie jeden Abschnitt aus.",
    placement: "top",
  },
  {
    target: "step-dokumente",
    title: "Schritt 2 · Dokumente",
    body: "Laden Sie die Pflichtdokumente für Ihre Rechtsform hoch (z.B. Ausweiskopie, HR-Auszug). Die Liste passt sich automatisch an – nur was wirklich nötig ist, wird angezeigt.",
    placement: "top",
  },
  {
    target: "step-signaturen",
    title: "Schritt 3 · Signaturen",
    body: "Sobald Stammdaten + Dokumente zu 75% abgeschlossen sind, können Sie hier digital unterschreiben. PandaDoc öffnet den Vertrag sicher in einem neuen Tab.",
    placement: "top",
  },
];
...
function DashboardPage() {
  ...
  return (
    <CoachmarkTour steps={TOUR_STEPS}>
      ...
      >
        {/* Tour-Trigger Button (floating, bottom-center) */}
        <TourStartButton />
